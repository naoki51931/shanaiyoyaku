...
export default function List(props) {
    ...
    const openEditModal = (id, office_name, office_id) => {
        setId(id);
                ...
                <TableRow key={v.id}>
                    ...
                    <TableCell align="center">
                        <Button variant="outlined" 
                                onClick={() => {openEditModal(v.id, v.office_name, v.office_id)}}>
                            Edit
                        </Button>
                    </TableCell>
                </TableRow>
            ...
            <div>
                ...
                >
                    <Edit
                        ...
                        id={id} office_name={office_name} setOffice_name={setOffice_name} office_id={office_id} setOffice_id={setOffice_id}
                    />
                </Modal>
            </div>
        </TableContainer>
